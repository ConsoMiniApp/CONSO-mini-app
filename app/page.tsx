...
export default function Home() {
  ...
  async function getTelegramUserDetails(urlEncodedData: string) {
    if (!urlEncodedData) return; // not running inside telegram environment : CHECK HERE
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      getTelegramUserDetails(urlEncodedData);
    }
  }, []);
